#include "../include/lib/bitmap.h"     //不仅是为了通过一致性检查，位图的数据结构struct bitmap也在这里面
#include "../include/stdint.h"     
#include "../include/lib/string.h"     //里面包含了内存初始化函数，memset
#include "../include/lib/print.h"
#include "../include/kernel/interrupt.h"
#include "../include/kernel/debug.h"      //ASSERT
